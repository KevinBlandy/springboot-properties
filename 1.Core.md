...
| `logging.file.max-history` | `7.0` | Maximum number of days archive log files are kept. Only supported with the default logback setup. |
...
| `spring.quartz.jdbc.schema` | None | Path to the SQL file to use to initialize the database schema. |
