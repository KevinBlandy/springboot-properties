...
| `spring.jta.bitronix.connectionfactory.failed` |  | spring.jta.bitronix.connectionfactory.failed |
...
| `spring.jta.bitronix.datasource.failed` |  | spring.jta.bitronix.datasource.failed |
